...
function App() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
            ...
            {/* LOADER */}
            <div className="pgx-loader" style={{ width: loaderWidth + '%' }} />
            ...
            <div className="pgx-main">
                ...
                <div>
                    ...
                    <AnimatePresence mode="wait">
                                ...
                                <TiltCard style={{ marginBottom: 16 }}>
                                    <div className="pgx-card">
                                        ...
                                        <div className="pgx-card-body">
                                            ...
                                            <div style={{ textAlign: 'center', paddingTop: 24 }}>
                                                <button className="btn-analyze" onClick={handleAnalyze} disabled={!canAnalyze || loading}>
                                                    {loading ? (
                                                        <>
                        ...
                        {/* ── RESULTS  ── */}
                        {step === 'results' && (
                            <motion.div key="results-step" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                                <button
                                    onClick={() => { setStep(2); setResults(null); }}
                                    style={{ marginBottom: 16, background: 'transparent', border: '1px solid var(--border)', color: 'var(--text-secondary)', fontSize: 12, padding: '8px 16px', borderRadius: 8, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}
                                >
                ...
                <>
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                            ...
                            <div>
                                <div style={{ fontSize: 14, fontWeight: 600, color: '#6EE7B7', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
                                    Analysis complete
                                </div>
                                <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>
                                    Want to test a different patient or file?
                                </div>
                            </div>
                        </div>
                        <motion.button
